...
class HTMLUiSearchView{
    template: string;
    _shadowRoot: ShadowRoot;
    controller:HTMLUiSearchController;
...
class HTMLUiSearchController{
    view:HTMLUiSearchView;
    parent:HTMLUiSearch;
    controller:HTMLUiSearchController;

    constructor(parent:HTMLUiSearch) {
        this.parent = parent;
        this.view = new HTMLUiSearchView(this.parent._shadowRoot);
    }
}

export class HTMLUiSearch extends HTMLElement implements WebComponentLifeCycle{
    _shadowRoot: ShadowRoot;
    view: HTMLUiSearchView;
    controller: HTMLUiSearchController;
